...
const Billing = () => {
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse} data-aos="fade-down-right">
      ...
      <div className={layout.sectionInfo} data-aos="fade-up-left">
        <h2 className={styles.heading2}>
          Easily control your <br className="sm:block hidden" /> billing & invoicing.
        </h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
          Quod maxime, cum maiores delectus qui temporibus consequuntur nobis quam voluptate iste.
        </p>

        <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          <img src={apple} alt="apple_store" className="w-32 h-[42px] object-contain mr-5 cursor-pointer" />
          <img src={google} alt="google_store" className="w-32 h-[42px] object-contain cursor-pointer" />
        </div>
      </div>
    </section>
  )
